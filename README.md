...
Other note types felt too minimalistic or too complexe to me.  
They feature code for every customization setting a user may pick. This allows the card to be customized with only the fields or the interface of the card.

While this is convenient for most users, this comes at the cost of a cluttered code and field list.

This is why I have chosen the opposite approach for Kokki, the code and fields are kept simple so you can customize it with only a vague knowledge of HTML and CSS if ever needed.
...
- Sentence: The sentence in which you found the expression, follows AJATT recommendations
...
The card layout is inspired by the [Kiku](https://github.com/youyoumu/kiku) node type  
